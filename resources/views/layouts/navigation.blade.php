<nav x-data="{ open: false }" class="bg-component border-b border-border">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-gray-500 hover:text-muted hover:bg-gray-900 focus:outline-none focus:bg-gray-900 focus:text-muted transition duration-150 ease-in-out">
